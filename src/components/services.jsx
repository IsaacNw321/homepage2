...
export default function Services() {
  ...
  return (
    <section className="w-full py-16 bg-transparent md:bg-gray-900 lg:bg-gray-900">
            ...
            return (
              ...
              >
                <div className="bg-gray-800 p-6 rounded-lg w-full max-w-sm text-center flex flex-col justify-between h-full lg:h-108">
                  ...
                  {(service.link || service.download) && (
                    <div className="mt-4">
                      <a
                        href={service.link || service.download}
                        target={service.link ? "_blank" : undefined}
                        rel={service.link ? "noopener noreferrer" : undefined}
                        download={service.download ? true : undefined}
